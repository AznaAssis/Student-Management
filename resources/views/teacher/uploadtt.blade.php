...
<li><a href="/vtt">View TimeTable</a></li>
...
<li><a href="/logout">Logout</a></li>
    ...
    <div>
        <div class="container">
             <form action="/ttaction" method="post" style="width=25%" enctype="multipart/form-data" style="padding-top:4%;padding-bottom:2%">
             @csrf
