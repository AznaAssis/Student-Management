...
<body>
    ...
    <div>
    <a href="/login" style="font-size:20px;padding-left:1200px;color:black;font-family: Arial, Helvetica, sans-serif;">Student Login?</a>
    </div>
    ...
    <div>
        <div class="container">
             <form action="/alogaction" method="post" style="width=25%" style="padding-top:4%;padding-bottom:2%">
             @csrf
