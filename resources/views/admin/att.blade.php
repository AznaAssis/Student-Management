...
<body>
                    ...
                    <div class="col-xl-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                ...
                                <li><a href="/asyllabus">Approve Syllabus</a></li>

                                <li class='active'><a  href="/att">Approve  TimeTable</a></li>
    ...
    <div><center><h2 style="background-color:lightgrey;padding:5%">VIEW TimeTable</h2></center></div>
    <div class="container">
        <div class="table-responsive" style="font-size:20px">
            <table class="table" boreder="1px,black,solid">
                ...
                <tr>
                    ...
                    <td>{{$val->status}}</td>
                    <td><a href="/apptt/{{$val->id}}">Approve</a></td>
                </tr>
                @endforeach
            </table>
        </div>
