...
<body>
                    ...
                    <div class="col-xl-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                ...
                                <li class='active'><a href="/ateacher">Approve Teachers</a></li>
    ...
    <div >
        <center><h2 style="background-color:lightgrey;padding:5%">VIEW TEACHERS</h2></center>
        <div class="table-responsive" style="font-size:20px">
            <table class="table" boreder="1px,black,solid">
                ...
                <tr>
                    ...
                    <td>{{$val->address}}</td>
                    <td>{{$val->status}}</td>
                    <td><a href="/appteach/{{$val->id}}">Approve</a></td>
                </tr>
                @endforeach
            </table>
        </div>
