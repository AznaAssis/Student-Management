...
<div class="wrap">
    ...
    <main>
        <div>
            <div class="container">
                <form action="/faction" style="width=25%" method="post" style="padding-top:4%;padding-bottom:2%">
                @csrf
                <div class="form-group" >
                    <label  class="control-label" for="teacher">Teacher</label>
                    <select name="teacher"class="form-control" required>
		 			<option selected="selected" disabled="disabled" value="default">Select teacher</option>
                     @foreach($res as $val)
                 ...
                 @endforeach
                    ...
                    <div class="control-label" class="form-group" >
                        <label class="control-label" for="feedback">Enter Your Feedback</label>
                        <textarea name="feedback" class="form-control" rows="10"></textarea>
                    </div>
                    <div>
                        <input type="submit" value="Send feedback" class="btn btn-info btn-block">
                    </div>
                </form>
            </div>
        </div>
